...
def predict_append():
    ...
    for (i, c) in enumerate(ctrs):
        ...
        if h > 80:
            ...
            roi = cv2.resize(subImg, (28, 28), interpolation=cv2.INTER_AREA)
            ...
            threshold = 130
            im_th = blurred_image.point(lambda p: p > threshold and 255)
            im_resize = im_th.resize((28,28), PIL.Image.ANTIALIAS)
